"""
Django settings for furnitart project.
...
WSGI_APPLICATION = 'furnitart.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'furnitart'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'furnitart@example.com'
    IT_SUPPORT_EMAIL = 'belli29@hotmail.com'
else:
    ...
    IT_SUPPORT_EMAIL = os.environ.get('IT_SUPPORT_EMAIL')
